...
bool is_cobra_rebug(void)
{
	sysFSStat stat;
	if(sysLv2FsStat("/dev_flash/rebug/cobra/stage2.cex", &stat) == SUCCESS) return true;
	else if(sysLv2FsStat("/dev_flash/rebug/cobra/stage2.cex.bak", &stat) == SUCCESS) return true;
	else return false;
}
...
int main()
{
	if(is_cobra_rebug())
	{
		...
		//Install new stage2.cex
		if((sysLv2FsStat("/dev_blind/rebug/cobra/stage2.cex", &stat) == SUCCESS))
		{
			sysLv2FsChmod("/dev_blind/rebug/cobra/stage2.cex", 0777);
			if((sysLv2FsStat("/dev_blind/rebug/cobra/stage2.cex.old", &stat) != SUCCESS))
			{
				sysLv2FsRename("/dev_blind/rebug/cobra/stage2.cex", "/dev_blind/rebug/cobra/stage2.cex.old");
				sysLv2FsChmod("/dev_blind/rebug/cobra/stage2.cex.old", 0777);
			}
			if((sysLv2FsStat("/dev_blind/rebug/cobra/stage2.cex", &stat) == SUCCESS)) sysLv2FsUnlink("/dev_blind/rebug/cobra/stage2.cex");
			CopyFile("/dev_hdd0/game/PS3MAPI00/USRDIR/stage2.cex", "/dev_blind/rebug/cobra/stage2.cex");					
		}
		else if((sysLv2FsStat("/dev_flash/rebug/cobra/stage2.cex.bak", &stat) == SUCCESS))
		{
			sysLv2FsChmod("/dev_flash/rebug/cobra/stage2.cex.bak", 0777);
			if((sysLv2FsStat("/dev_blind/rebug/cobra/stage2.cex.old", &stat) != SUCCESS))
			{
				sysLv2FsRename("/dev_flash/rebug/cobra/stage2.cex.bak", "/dev_blind/rebug/cobra/stage2.cex.old");
				sysLv2FsChmod("/dev_blind/rebug/cobra/stage2.cex.old", 0777);
			}
			if((sysLv2FsStat("/dev_flash/rebug/cobra/stage2.cex.bak", &stat) == SUCCESS)) sysLv2FsUnlink("/dev_blind/sys//dev_flash/rebug/cobra/stage2.cex.bak");
			if((sysLv2FsStat("/dev_blind/rebug/cobra/stage2.cex", &stat) == SUCCESS)) sysLv2FsUnlink("/dev_blind/rebug/cobra/stage2.cex");
			CopyFile("/dev_hdd0/game/PS3MAPI00/USRDIR/stage2.cex", "/dev_blind/rebug/cobra/stage2.cex");					
		}
